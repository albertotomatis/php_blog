                     ...
                     <div class="card">
                       ...
                       <div class="card-body">
                         ...
                         <div class="text-muted" style="margin-top: 10px; margin-bottom: 10px;">
                                        <h4>di <?= htmlspecialchars($post->getAuthor()->name, ENT_QUOTES, 'UTF-8'); ?>
                                            il <?= $post->data; ?></h4>
                                    </div>   
                         <a href="index.php?route=post/singlepost&id=<?= $post->id; ?>" class="btn btn-azure w-100" style="margin-top: 10px; margin-bottom: 20px;">Leggi di +</a>
                         <?php if ($user) : ?>
                                        <!-- modifica ed elimina -->
